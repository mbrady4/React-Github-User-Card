...
## Plan of Action
1. Build out Class Component "GitHub User"
2. Initial User with state for the user
3. Render the user and info in the Render method
4. Create a componentDidMount method to fetch the data from the API
